...
var app_providers_externalMessagePort_provider_index = require('./externalMessagePort.provider/index.js');
...
class AppStoreProvider {
    ...
    clearTotalsAndErrors() {
        this.appStore.dispatch({
            type: app_store_index.Actions.CLEAR_TOTALS_AND_ERRORS,
            payload: undefined,
        });
    ...
    setActiveCell(cell, selectedCells) {
        this.appStore.dispatch({
            type: app_store_index.Actions.SET_ACTIVE_CELL,
    ...
    setCalculationError(error) {
        this.appStore.dispatch({
            type: app_store_index.Actions.SET_CALCULATION_ERROR,
            payload: error,
        });
        return Promise.resolve();
    }
    setCellsValue(cellsToUpdate, value, label, error, considerNormal, reasonImpairmentNotDueToSci, reasonImpairmentNotDueToSciSpecify) {
        this.appStore.dispatch({
            type: app_store_index.Actions.SET_CELLS_VALUE,
            payload: {
                cellsToUpdate,
                value,
                label,
    ...
    setExtraInputs(rightLowestNonKeyMuscleWithMotorFunction, leftLowestNonKeyMuscleWithMotorFunction, comments, cellComments) {
        this.appStore.dispatch({
            type: app_store_index.Actions.SET_EXTRA_INPUTS,
            payload: {
    ...
    setGridModel(gridModel) {
        this.appStore.dispatch({ type: app_store_index.Actions.SET_GRID_MODEL, payload: gridModel });
        return Promise.resolve();
    }
    setReadonly(readonly) {
        this.appStore.dispatch({ type: app_store_index.Actions.SET_READONLY, payload: readonly });
        return Promise.resolve();
    }
    setTotals(totals) {
        this.appStore.dispatch({ type: app_store_index.Actions.SET_TOTALS, payload: totals });
        return Promise.resolve();
    }
    setVacDap(vac, dap) {
        this.appStore.dispatch({ type: app_store_index.Actions.SET_VAC_DAP, payload: { vac, dap } });
        return Promise.resolve();
    }
    updateStatus(status) {
        this.appStore.dispatch({ type: app_store_index.Actions.UPDATE_STATUS, payload: status });
        return Promise.resolve();
    }
}
...
class IsncsciExamProvider {
    ...
    calculate(examData) {
        ...
        return Promise.resolve({
            asiaImpairmentScale: examData_helper.formatASIAImpairmentScale(classification.ASIAImpairmentScale),
            injuryComplete: examData_helper.formatCompleteIncomplete(classification.injuryComplete),
            leftLightTouchTotal: totals.left.lightTouch,
            leftLowerMotorTotal: totals.left.lowerExtremity,
            leftMotor: examData_helper.formatLevelName(classification.neurologicalLevels.motorLeft),
            leftMotorTotal: totals.left.motor,
            leftMotorZpp: examData_helper.formatLevelName(classification.zoneOfPartialPreservations.motorLeft),
            leftPinPrickTotal: totals.left.pinPrick,
            leftSensory: examData_helper.formatLevelName(classification.neurologicalLevels.sensoryLeft),
            leftSensoryZpp: examData_helper.formatLevelName(classification.zoneOfPartialPreservations.sensoryLeft),
            leftUpperMotorTotal: totals.left.upperExtremity,
            lightTouchTotal: totals.lightTouch,
            lowerMotorTotal: totals.lowerExtremity,
            neurologicalLevelOfInjury: examData_helper.formatLevelName(classification.neurologicalLevelOfInjury),
            ...
            rightMotor: examData_helper.formatLevelName(classification.neurologicalLevels.motorRight),
            rightMotorTotal: totals.right.motor,
            rightMotorZpp: examData_helper.formatLevelName(classification.zoneOfPartialPreservations.motorRight),
            rightPinPrickTotal: totals.right.pinPrick,
            rightSensory: examData_helper.formatLevelName(classification.neurologicalLevels.sensoryRight),
            rightSensoryZpp: examData_helper.formatLevelName(classification.zoneOfPartialPreservations.sensoryRight),
...
exports.ExternalMessagePortProvider = app_providers_externalMessagePort_provider_index.ExternalMessagePortProvider;
exports.ExternalMessagePortProviderActions = app_providers_externalMessagePort_provider_index.ExternalMessagePortProviderActions;
exports.AppStoreProvider = AppStoreProvider;
exports.IsncsciExamProvider = IsncsciExamProvider;
