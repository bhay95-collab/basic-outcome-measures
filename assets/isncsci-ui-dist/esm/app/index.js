...
import { initializeAppUseCase, clearExamUseCase, calculateUseCase, loadExternalExamDataUseCase, setReadonlyUseCase } from '../core/useCases/index.js';
import '../getNextActiveCell.useCase-fdf9a1cc.js';
import { g as getEmptyExamData } from '../examData.helper-51d9ca17.js';
import { Actions } from './store/index.js';
import { ExternalMessagePortProvider } from './providers/externalMessagePort.provider/index.js';
import { InputLayoutController, KeyPointDiagramController } from './controllers/index.js';
import '../core/helpers/index.js';
...
class PraxisIsncsciWebApp extends HTMLElement {
    ...
    constructor() {
        ...
        this.externalMessagePortProvider = new ExternalMessagePortProvider();
    ...
    initialize(appStore, appStoreProvider, isncsciExamProvider) {
        ...
        new InputLayoutController(this.appStore, this.appStoreProvider, this.externalMessagePortProvider, inputLayout, inputButtons, this.classification);
        new KeyPointDiagramController(this.appStore, keyPointsDiagram);
    ...
    classify() {
        ...
        calculateUseCase((_a = state.gridModel) !== null && _a !== void 0 ? _a : [], state.vac, state.dap, state.rightLowestNonKeyMuscleWithMotorFunction, state.leftLowestNonKeyMuscleWithMotorFunction, state.comments, this.appStoreProvider, this.isncsciExamProvider, this.externalMessagePortProvider);
    ...
    externalMessagePortProvider_onExamData(examData) {
        ...
        this.closeClassification();
        loadExternalExamDataUseCase(this.appStoreProvider, examData !== null && examData !== void 0 ? examData : getEmptyExamData());
    }
    ...
    stateChanged(state, actionType) {
        ...
        if (actionType === Actions.SET_CALCULATION_ERROR &&
